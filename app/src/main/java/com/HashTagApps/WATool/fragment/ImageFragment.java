...
public class ImageFragment extends Fragment {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        StatusSaverActivity.imageFragmentVisible = isVisibleToUser;
    }
    ...
    public void addView(ArrayList<FileItem> fileItems) {
        ...
        statusSaverActivity.imageFileAdapter = new ImageFileAdapter(fileItems, statusSaverActivity);
        recyclerView.setLayoutManager((new GridLayoutManager(getContext(),2)));
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(statusSaverActivity.imageFileAdapter);
