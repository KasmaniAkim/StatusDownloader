...
public class SavedFileAdapter extends RecyclerView.Adapter<SavedFileAdapter.ViewHolder> {
    ...
    public SavedFileAdapter(ArrayList<FileItem> fileItems, StatusSaverActivity statusSaverActivity, String type) {
            ...
            public void onClick(View v) {
                ...
                if (isChecked) {
                    ...
                    if (type.equals("image")) {
                        ...
                        Intent intent = new Intent(statusSaverActivity, VideoPlayerActivity.class);
                        intent.putExtra("position", viewHolder.getAdapterPosition());
                        intent.putExtra("type", "saved");
