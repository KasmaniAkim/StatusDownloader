...
public class SendCleanerImageAdapter extends RecyclerView.Adapter<SendCleanerImageAdapter.ViewHolder> {
    ...
    public SendCleanerImageAdapter(ArrayList<FileItem> fileItems, FileExplorerActivity fileExplorerActivity) {
        ...
        viewHolder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isChecked) {
                    ...
                    if (fileItem.getFile().getAbsolutePath().endsWith(".jpg")) {
                        ...
                        intent.putExtra("sort", fileExplorerActivity.sentSort);
                        intent.putExtra("small_sort", fileExplorerActivity.sentSmallSort);
                        intent.putExtra("latest",fileExplorerActivity.sentLatestFirst);
                        intent.putExtra("oldest",fileExplorerActivity.sentOldestFirst);
