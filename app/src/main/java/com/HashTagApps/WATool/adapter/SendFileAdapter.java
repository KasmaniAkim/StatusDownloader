...
public class SendFileAdapter extends RecyclerView.Adapter<SendFileAdapter.ViewHolder>  implements Filterable {
    ...
    public SendFileAdapter(ArrayList<FileItem> folderItems, FileExplorerActivity fileExplorerActivity) {
